...
function lib_type(&$ctag,&$refObj)
{
  ...
  if(empty($typeid)) return '';
    ...
    $row = $dsql->GetOne("SELECT id,typename,typenameen,description,typedir,typenameen,typeimg,description,isdefault,ispart,defaultname,namerule2,moresite,siteurl,sitepath 
